...
namespace beer.umajkla.web.Controllers
{
    public class HomeController : Controller
    {
        public ActionResult Index()
        {
            ...
            List<Transaction> transactions = new Transaction().ListByItem(kofola);
            List<Supply> supplies = new Supply().ListByItem(kofola);
            ...
            {
                List<Transaction> customerTransactions = new Transaction().ListByCustomer(customer.CustomerId);
                List<Payment> payments = new Payment().ListByCustomer(customer.CustomerId);
